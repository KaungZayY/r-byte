        ...
        <div x-data="{ edit: false }" x-cloak class="px-16 md:px-40 lg:px-80">
            ...
            <div class="mt-4">
                <div class="mt-4 flex items-center">
                    ...
                    <select wire:model="sprint_id" x-bind:disabled="! edit" id="sprint_id" name="sprint_id" class="block w-3/4 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
            ...
            <div class="mt-4">
                <div class="mt-4 flex items-center">
                    ...
                    <x-input wire:model="ticket_name" id="ticket_name" class="block w-3/4" type="text" name="ticket_name"
            ...
            <div class="mt-4">
                <div class="mt-4 flex items-center">
                    ...
                    <x-input wire:model="duration" id="duration" class="block w-3/4" type="number" name="duration" autofocus
