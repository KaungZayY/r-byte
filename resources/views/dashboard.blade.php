        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-black overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="flex flex-col md:flex-row">
                    <!-- foreach -->
                    <div class="w-full h-auto md:w-1/2 lg:w-1/3 flex flex-col rounded-lg bg-white px-6 py-4 m-1 text-black dark:text-white dark:bg-black border border-gray-400 dark:border-gray-600">
