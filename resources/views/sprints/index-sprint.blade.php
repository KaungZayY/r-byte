        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-3">
                ...
                <div class="flex space-x-4 items-center">
                    @if (viewContent($project, 'Sprints', 'Archives'))
                        <form action="{{route('sprints.archives',$project)}}" method="GET">
                    ...
                    @endif
                    @if (viewContent($project, 'Sprints', 'Create'))
                        ...
                        @foreach ($sprints as $sprint)
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-800">
                                <td class="px-4 py-4 max-w-xs text-sm font-medium text-gray-900 dark:text-white text-center">
                                    @if ($sprint->status === 'inactive' && viewContent($project, 'Sprints', 'StartSprint'))
                                ...
                                <td class="px-4 py-4 max-w-xs text-sm text-gray-500 dark:text-gray-300 text-center">
                                    <div class="inline-block">
                                        <form action="{{route('tickets', ['project' => $project, 'sprint' => $sprint])}}" method="GET">
                                            <button title="Tickets">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height="18" width="18">
                                                    <path fill="#9333ea" d="M152.1 38.2c9.9 8.9 10.7 24 1.8 33.9l-72 80c-4.4 4.9-10.6 7.8-17.2 7.9s-12.9-2.4-17.6-7L7 113C-2.3 103.6-2.3 88.4 7 79s24.6-9.4 33.9 0l22.1 22.1 55.1-61.2c8.9-9.9 24-10.7 33.9-1.8zm0 160c9.9 8.9 10.7 24 1.8 33.9l-72 80c-4.4 4.9-10.6 7.8-17.2 7.9s-12.9-2.4-17.6-7L7 273c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l22.1 22.1 55.1-61.2c8.9-9.9 24-10.7 33.9-1.8zM224 96c0-17.7 14.3-32 32-32l224 0c17.7 0 32 14.3 32 32s-14.3 32-32 32l-224 0c-17.7 0-32-14.3-32-32zm0 160c0-17.7 14.3-32 32-32l224 0c17.7 0 32 14.3 32 32s-14.3 32-32 32l-224 0c-17.7 0-32-14.3-32-32zM160 416c0-17.7 14.3-32 32-32l288 0c17.7 0 32 14.3 32 32s-14.3 32-32 32l-288 0c-17.7 0-32-14.3-32-32zM48 368a48 48 0 1 1 0 96 48 48 0 1 1 0-96z"/>
                                                </svg>
                                            </button>
                                        </form>
                                    </div>
                                    ...
                                    @endif
                                    @if (viewContent($project, 'Sprints', 'Delete'))
                                        <span class="ml-2 mr-2">|</span>
                                        <div class="inline-block">
                                            <form action="{{route('sprints.delete',$sprint)}}" method="POST" onsubmit="return confirm('Remove this sprint?');">
                                                @csrf
                                                @method('DELETE')
                                                <button title="Delete">
